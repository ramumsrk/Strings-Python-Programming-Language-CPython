...
def main() -> None:
  ...
  third_string_literal: LiteralString = sys.intern('Longer string that is not interned')
  fourth_string_literal: LiteralString = sys.intern('Longer string that is not interned')
  logging.debug(f'{id(third_string_literal)=}')
  logging.debug(F'{id(fourth_string_literal)=}')  
  logging.debug(f'{third_string_literal is fourth_string_literal=}')  
